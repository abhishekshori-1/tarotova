...
export interface ResultSnapshot {
  ...
  overview: string;
  reflection: string;
  cards: { position: (typeof POSITIONS)[number]; id: string; name: string; numeral: string; keywords: string[]; coreMeaning?: string; exploration?: string; interpretation: string; focusNote: string }[];
  deckVersion: string;
